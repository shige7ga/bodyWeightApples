...
ActiveRecord::Schema[7.2].define(version: 2026_03_23_102944) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.bigint "user_id"
    t.bigint "weight_record_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_comments_on_user_id"
    t.index ["weight_record_id"], name: "index_comments_on_weight_record_id"
  end
  ...
  add_foreign_key "comments", "weight_records"
